...
TESTS_BY_RUNTIME = {
    "stock": (
        ...
        "test_v3_bosch_focused_ion_map.py",
        "test_v3_bosch_focused_ion_map_review.py",
        "test_v3_bosch_grid_speed_bridge.py",
        "test_v3_bosch_grid_speed_bridge_phase_b.py",
        "test_v3_bosch_interior_descriptive_review.py",
